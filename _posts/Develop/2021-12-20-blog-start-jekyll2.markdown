...
![new-ter-menu](/assets/img/post-img/jekyll-start/new-ter.webp)  

위에서 실행시킨 명령창과 동일한 창이 아래와 같이 생긴다.  
![new-ter2](/assets/img/post-img/jekyll-start/new-ter2.webp)  
...
![jekyll-run](/assets/img/post-img/jekyll-start/jekyll-run.webp)  

접속하면 다음과 같은 화면이 나올 것이다.  
![first-page](/assets/img/post-img/jekyll-start/first-page.webp)  
...
![jekyll-list](/assets/img/post-img/jekyll-start/jekyll-theme.webp)  

일반적으로 PC 에서의 화면이다.  
![jekyll-list](/assets/img/post-img/jekyll-start/theme-h.webp)  

<br>

가로를 극단적으로 줄여보자. 어느순간 화면이 바뀌는걸 볼 수 있다.  
반응형이 아니면, 사이즈에 상관없이 같은 디자인을 가진다.  
![jekyll-list](/assets/img/post-img/jekyll-start/theme-v.webp)  
...
![jekyll-start](/assets/img/post-img/jekyll-start/jekyl-start-theme.webp)   
...
![github-desk](/assets/img/post-img/jekyll-start/github-desktop.webp)   
아래와 같이 add repository 를 선택하자. ( new 가 아니다. )  
![add-repo](/assets/img/post-img/jekyll-start/add-repo.webp)   
<br>

그리고 여태것 작업한 폴더를 선택한다. 그러면 다음과 같은 화면이 나온다.  
![github-page](/assets/img/post-img/jekyll-start/github-page.webp)    
...
![github-page](/assets/img/post-img/jekyll-start/commit.webp)    
...
![github-page](/assets/img/post-img/jekyll-start/commit-history.webp)    

ABCD 이런식으로 Commit 하면 나중에 찾기 곤란하다.  
<br>

참고로 Commit 후 파일을 변경했는데, 변경한걸 마지막 Commit 으로 되돌리고 싶다면 Discard 시키면 된다.  
![github-page](/assets/img/post-img/jekyll-start/discard.webp)   


Commit 을 다했으면 상단에 Push 를 누르자.  
![github-page](/assets/img/post-img/jekyll-start/push.webp)   
***push 는 내 로컬에 Commit 된 것을 GitHub 서버의 내 Repository 에 반영해준다.***  
GitHub 서버의 내 Repository 에 반영을 해야 실제 웹에 올라가게 된다.  

![github-page](/assets/img/post-img/jekyll-start/start-web.webp) 
...
![bundle-exec](/assets/img/post-img/jekyll-start/bundle-exec.webp)  
